          ...
          >
            ...
            {showWhatsAppButton && (
              <div className="mt-4 flex justify-center">
                <a
                  href="https://chat.whatsapp.com/KrKKOjf2P0d8Ubc25zJmRC"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center bg-[#25D366] text-white font-semibold py-2 px-4 rounded-lg hover:bg-[#128C7E] transition duration-300 transform hover:scale-105"
                >
                  <svg
